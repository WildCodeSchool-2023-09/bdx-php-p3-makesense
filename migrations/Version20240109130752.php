 ...
 */
final class Version20240109130752 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE decision (id INT AUTO_INCREMENT NOT NULL, groupappelation_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, status TINYINT(1) NOT NULL, description LONGTEXT NOT NULL, impact LONGTEXT NOT NULL, context LONGTEXT NOT NULL, benefits LONGTEXT NOT NULL, risk LONGTEXT NOT NULL, starting_date DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', deadline_opinion DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', deadline_decision DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', deadline_conflict TIME NOT NULL COMMENT \'(DC2Type:time_immutable)\', deadline_final TIME NOT NULL COMMENT \'(DC2Type:time_immutable)\', INDEX IDX_84ACBE484FFB754B (groupappelation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE decision ADD CONSTRAINT FK_84ACBE484FFB754B FOREIGN KEY (groupappelation_id) REFERENCES `group` (id)');
